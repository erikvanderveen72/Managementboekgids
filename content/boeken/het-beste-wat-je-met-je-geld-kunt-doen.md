---
title: "Het beste wat je met je geld kunt doen"
subtitle: "Hoe je met effectief geven de wereld kunt veranderen"
authors:
  - "Bram Schaper"
...
forWhom:
  ...
  - "Particulieren die hun giften willen heroverwegen"
  - "Fondsen en vermogende families met een filantropische portefeuille"
  - "Iedereen die geïnteresseerd is in effectief altruïsme"
notForWhom:
  - "Wie geven vooral als emotioneel gebaar ziet"
  - "Lezers die sceptisch staan tegenover rationele benaderingen van goed doen"
  - "Traditionele goede-doelen-organisaties die hun model niet ter discussie willen stellen"
strongPoints:
  - "Rustig, wetenschappelijk onderbouwd, zonder moraliseren"
  - "Concrete criteria en organisaties genoemd"
  - "Nederlandse vertaling van effectief altruïsme die toegankelijk blijft"
weakPoints:
  - "Koel-rationele toon kan afstand scheppen bij sommige lezers"
...
scores:
  ...
  beginnerFriendly: 8
lessons:
  - title: "Grootte is geen kwaliteit"
    description: "De bekendste goede doelen zijn niet per se de effectiefste. Marketingkracht correleert niet met impact per euro."
...
affiliate:
  managementboek: "https://www.managementboek.nl/zoeken?zoekterm=beste+wat+je+met+je+geld+schaper"
---
...
Voor particulieren biedt het boek een heldere methode om je jaarlijkse donaties opnieuw te bekijken. Voor ondernemers die maatschappelijke impact willen combineren met commercieel succes, is het een uitstekende introductie tot hoe je die ambitie kunt concretiseren. Voor fondsen en families met substantiële filantropische middelen is het een uitnodiging om criteria en keuzemodellen te professionaliseren.

## Mijn oordeel

**Koop dit boek als** je regelmatig geeft aan goede doelen en je wilt weten of je keuzes optimaal zijn, of als effectief altruïsme als beweging je interesseert.

**Sla dit boek over als** geven voor jou vooral een emotioneel gebaar is en je niet gediend bent van rationele optimalisatie van dat gebaar.
